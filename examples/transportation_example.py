...
project = ProjectLogisticManager().set_name("Building A").set_shipping_dest("Pennsylvania").set_shipping_org(None)

project.create_link ( material="isuru", qty=1, travel_dist= "NA",
