...
print("Radiative efficiency of CH4 (in Wm-2ppb-1):", DynamicRadiativeForcing().get_radiative_efficiency("CH4", ref_unit='Wm-2ppb-1', adjust_for_indirect_effects=False))
print("Radiative efficiency of N2O (in Wm-2ppb-1):", DynamicRadiativeForcing().get_radiative_efficiency("N2O", ref_unit='Wm-2ppb-1', adjust_for_indirect_effects=False))
print("=" * 15)
print("Radiative efficiency of CO2 (in Wm-2kg-1):", DynamicRadiativeForcing().get_radiative_efficiency("CO2", ref_unit='Wm-2kg-1'))
print("Radiative efficiency of CH4 (in Wm-2kg-1):", DynamicRadiativeForcing().get_radiative_efficiency("CH4", ref_unit='Wm-2kg-1', adjust_for_indirect_effects=False))
print("Radiative efficiency of N2O (in Wm-2kg-1):", DynamicRadiativeForcing().get_radiative_efficiency("N2O", ref_unit='Wm-2kg-1', adjust_for_indirect_effects=False))
print("=" * 15)
print("Radiative efficiency of CH4, adjusted for indirect effects (in Wm-2kg-1):", DynamicRadiativeForcing().get_radiative_efficiency("CH4", ref_unit='Wm-2kg-1', adjust_for_indirect_effects=True))
print("Radiative efficiency of N2O, adjusted for indirect effects (in Wm-2kg-1):", DynamicRadiativeForcing().get_radiative_efficiency("N2O", ref_unit='Wm-2kg-1', adjust_for_indirect_effects=True))
print("=" * 15)
print("Radiative efficiency of CH4, adjusted for indirect effects (in Wm-2ppb-1):", DynamicRadiativeForcing().get_radiative_efficiency("CH4", ref_unit='Wm-2ppb-1', adjust_for_indirect_effects=True))
print("Radiative efficiency of N2O, adjusted for indirect effects (in Wm-2ppb-1):", DynamicRadiativeForcing().get_radiative_efficiency("N2O", ref_unit='Wm-2ppb-1', adjust_for_indirect_effects=True))
