...
print("Radiative efficiency of N2O, adjusted for indirect effects (in Wm-2kg-1):", DynamicRadiativeForcing.get_radiative_efficiency("N2O", ref_unit='Wm-2kg-1'))
...
print("Radiative efficiency of CH4, adjusted for indirect effects (in Wm-2kg-1):", DynamicRadiativeForcing.get_radiative_efficiency("CH4", ref_unit='Wm-2kg-1'))
