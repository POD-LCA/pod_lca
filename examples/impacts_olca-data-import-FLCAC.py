...
renewable_fuels_process_list = DataImporter.csv_to_list(
    "./data/impacts_flcac_renewable-fuels-group.csv", column_header="UUID"
)
nonrenewable_fuels_process_list = DataImporter.csv_to_list(
    "./data/impacts_flcac_nonrenewable-fuels-group.csv", column_header="UUID"
)
...
results = openLCA.generate_impacts_dir(
    openLCA_client, process_list_all, impact_categories | inventories, impact_method_uuid, group_by
)
