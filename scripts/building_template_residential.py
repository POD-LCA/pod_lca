...
# template_model_data = DataImporter.json_to_dict(current_folder / 'Template_Model_data.json') # Alternatively, load from a JSON file

# TODO: account for interior finishes
