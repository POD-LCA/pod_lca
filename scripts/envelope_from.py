...
layers = {
          0: {'classification':'exterior_cladding', 'material': 'Clay brick', 'thickness': Q(0, METER) + Q(0.75, INCH)},
          1: {'classification':'air_gap', 'material': 'Generic Wall Air Gap', 'thickness': Q(0, METER) + Q(1.5, INCH)},
          2: {'classification':'exterior_insulation', 'material': 'Expanded polystyrene (EPS) Type 1', 'thickness': Q(0, METER) + Q(1.5, INCH)},
          3: {'classification':'sheathing', 'material': 'Gypsum board', 'thickness': Q(0, METER) + Q(0.5, INCH)},
          4: {'classification':'framing_insulation', 'material': 'Mineral wool blanket baseline', 'thickness': Q(0, METER) + Q(2.0, INCH)},
          5: {'classification':'interior_finish', 'material': 'Gypsum board', 'thickness': Q(0, METER) + Q(0.5, INCH)}
          }

framing = {'name': 'metal_16in', 
           'type': 'Metal', 
           'member': '400S125-18', 
           'spacing': Q(0, METER) + Q(16.0, INCH),
           'L':   Q(0, METER) + Q(1.25, INCH),
           'ds':  Q(0, METER) + Q(2, INCH),
           'dII': Q(0, METER) + Q(0.043, INCH)}

layers_ = {}
for lk in layers:
    name = layers[lk]['material']
    thickness = Q(0, METER) + layers[lk]['thickness']
