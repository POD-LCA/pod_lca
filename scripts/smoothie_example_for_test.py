...
sprinkles = project.current_model.add_product("Sprinkles", "A1")
sprinkles.update_qty(2.0)
sprinkles.set_unit('kg')
sprinkles.set_impact_database_entry("Sprinkles")

sand = project.current_model.add_product("Sand", "A1")
sand.update_qty(1.0)
sand.set_unit('kg')
sand.set_impact_database_entry("Sand")

pickles = project.current_model.add_product("Pickles", "A1")
pickles.update_qty(4.0)
pickles.set_unit('kg')
pickles.set_impact_database_entry("Pickles")

propane = project.current_model.add_energy("Propane", "A1")
...
electricity = project.current_model.add_energy("Electricity for Mixing", "A3")
electricity.update_qty(3.0)
electricity.set_unit('kWh')
electricity.set_impact_database_entry("Electricity_New")

propane_transported = project.current_model.add_energy("Propane for Mixing", "A3")
propane_transported.update_qty(1.0)
propane_transported.set_unit('MJ')
propane_transported.set_impact_database_entry("Propane")

product_1 = project.current_model.add_product("Product of mixing", "A3")
product_1.update_qty(3.0)
product_1.set_unit('kg')

product_2 = project.current_model.add_product("Product of mixing", "A3")
...
electricity_2 = project.current_model.add_energy("Electricity for Chemical Reaction", "A3")
electricity_2.update_qty(10.0)
electricity_2.set_unit('kWh')
electricity_2.set_impact_database_entry("Electricity")

CO2 = project.current_model.add_emission("CO2", "A3")
CO2.update_qty(0.5)
CO2.set_unit('kg')
CO2.set_impact_database_entry("CO2")

CH4 = project.current_model.add_emission("CH4", "A3")
CH4.update_qty(0.6)
CH4.set_unit('kg')
CH4.set_impact_database_entry("CH4")

NH3 = project.current_model.add_emission("NH3", "A3")
NH3.update_qty(0.7)
NH3.set_unit('kg')
NH3.set_impact_database_entry("NH3")

waste = project.current_model.add_waste("Waste to landfill", "A3")
...
sprinkles = model2.add_product("Sprinkles", "A1")
sprinkles.set_qty(40.0)
sprinkles.set_unit('kg')
sprinkles.set_impact_database_entry("Sprinkles")

sand = model2.add_product("Sand", "A1")
sand.set_qty(10.0)
sand.set_unit('kg')
sand.set_impact_database_entry("Sand")

pickles = model2.add_product("Pickles", "A1")
pickles.set_qty(4.0)
pickles.set_unit('kg')
pickles.set_impact_database_entry("Pickles")

propane = model2.add_energy("Propane", "A1")
propane.set_qty(12.0)
propane.set_unit('MJ')
propane.set_density(0.02)
propane.set_weight_unit('kg')
propane.set_impact_database_entry("Propane")
...
electricity = model2.add_energy("Electricity for Mixing", "A3")
electricity.set_qty(3.0)
electricity.set_unit('kWh')
electricity.set_impact_database_entry("Electricity_New")

propane_transported = model2.add_energy("Propane for Mixing", "A3")
propane_transported.set_qty(10.0)
propane_transported.set_unit('MJ')
propane_transported.set_impact_database_entry("Propane")

product_1 = model2.add_product("Product of mixing", "A3")
product_1.set_qty(3.0)
product_1.set_unit('kg')

product_2 = model2.add_product("Product of mixing", "A3")
...
electricity_2 = model2.add_energy("Electricity for Chemical Reaction", "A3")
electricity_2.set_qty(10.0)
electricity_2.set_unit('kWh')
electricity_2.set_impact_database_entry("Electricity")

CO2 = model2.add_emission("CO2", "A3")
CO2.set_qty(0.5)
CO2.set_unit('kg')
CO2.set_impact_database_entry("CO2")

CH4 = model2.add_emission("CH4", "A3")
CH4.set_qty(0.6)
CH4.set_unit('kg')
CH4.set_impact_database_entry("CH4")

NH3 = model2.add_emission("NH3", "A3")
NH3.set_qty(0.1)
NH3.set_unit('kg')
NH3.set_impact_database_entry("NH3")

waste = model2.add_waste("Waste to landfill", "A3")
waste.set_qty(1.0)
waste.set_unit('kg')
waste.set_impact_database_entry("Waste to landfill")
...
sprinkles = model3.add_product("Sprinkles", "A1")
sprinkles.set_qty(24.0)
sprinkles.set_unit('kg')
sprinkles.set_impact_database_entry("Sprinkles")

sand = model3.add_product("Sand", "A1")
sand.set_qty(11.0)
sand.set_unit('kg')
sand.set_impact_database_entry("Sand")

pickles = model3.add_product("Pickles", "A1")
pickles.set_qty(4.0)
pickles.set_unit('kg')
pickles.set_impact_database_entry("Pickles")

propane = model3.add_energy("Propane", "A1")
propane.set_qty(16.0)
propane.set_unit('MJ')
propane.set_density(0.02)
propane.set_weight_unit('kg')
propane.set_impact_database_entry("Propane")
...
electricity = model3.add_energy("Electricity for Mixing", "A3")
electricity.set_qty(35.0)
electricity.set_unit('kWh')
electricity.set_impact_database_entry("Electricity_New")

propane_transported = model3.add_energy("Propane for Mixing", "A3")
propane_transported.set_qty(10.0)
propane_transported.set_unit('MJ')
propane_transported.set_impact_database_entry("Propane")

product_1 = model3.add_product("Product of mixing", "A3")
product_1.set_qty(3.0)
product_1.set_unit('kg')

product_2 = model3.add_product("Product of mixing", "A3")
product_2.set_qty(4.0)
product_2.set_unit('kg')
...
electricity_2 = model3.add_energy("Electricity for Chemical Reaction", "A3")
electricity_2.set_qty(10.0)
electricity_2.set_unit('kWh')
electricity_2.set_impact_database_entry("Electricity")

CO2 = model3.add_emission("CO2", "A3")
CO2.set_qty(0.9)
CO2.set_unit('kg')
CO2.set_impact_database_entry("CO2")

CH4 = model3.add_emission("CH4", "A3")
CH4.set_qty(0.6)
CH4.set_unit('kg')
CH4.set_impact_database_entry("CH4")

NH3 = model3.add_emission("NH3", "A3")
NH3.set_qty(0.2)
NH3.set_unit('kg')
NH3.set_impact_database_entry("NH3")

waste = model3.add_waste("Waste to landfill", "A3")
waste.set_qty(3.0)
waste.set_unit('kg')
waste.set_impact_database_entry("Waste to landfill")
