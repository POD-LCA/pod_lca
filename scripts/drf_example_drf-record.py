...
emission_05 = Emissions.from_dict(record_dict={'N2O': 0.005})
...
drf_record.plot('emission intensity') # 'emission intensity', 'atmospheric concentration', 'instantaneous radiative forcing', 'cumulative radiative forcing'
# TODO: add plot types
