...
b = OperationalBuilding.from_quad_5zone(path, wea, quad, height=height, zone_depth=depth / 4.0)
data = get_idf_data(filepath)
b.add_data_from_idf(data)


zone = b.zones[0]
w = Window.from_wall_and_wwr(zone, 2, 0.6)
w.construction = "Generic Double Pane"
b.add_window(w)

zone = b.zones[1]
w = Window.from_wall_and_wwr(zone, 2, 0.2)
w.construction = "Generic Double Pane"
b.add_window(w)
