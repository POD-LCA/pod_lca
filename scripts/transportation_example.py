...
truck_1 = project.add_link (link_name = "QC2", shipping_dest = "Pennsylvania" , shipping_org = None,
                            ...
                            mode_foreign= "Ocean", mode_foreign_fuel_type = None, mode_foreign_efficiency = "Low")


truck_1.compute_impact()
print (truck_1.get_impact_domestic().get_impact_dict())
print (truck_1.get_impact_foreign().get_impact_dict())
print (truck_1.get_link_distances())
print (truck_1.get_return_trip_factor())

# print (truck_1.get_mode_domestic().get_impact().get_impact_dict())
# print (truck_1.get_mode_foreign().get_impact().get_impact_dict())

print (truck_1.get_electricity_consumption())

print (truck_1.get_mode_domestic())
print (truck_1.get_mode_foreign())