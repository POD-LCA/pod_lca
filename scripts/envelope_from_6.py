...
# NOTE: The above line does not work as BuildingEnvelope.from_envelope_and_stories() make deep copies of the envelopes 
        # and therefore loose the reference to the original layers.
...
# This will not work in a script environment where the changes are not rerun. 
