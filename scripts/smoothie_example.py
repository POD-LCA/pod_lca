...
sand_by_truck = model_0.add_transportation_process("Sand Transportation", "A2")
...
pickles_by_truck = model_0.add_transportation_process("Pickles Transportation", "A2")
...
propane_by_truck = model_0.add_transportation_process("Propane Transportation", "A2")
...
electricity = model_0.add_energy("Electricity for Mixing", "A3")
electricity.set_qty(3.0)
electricity.set_unit(KILO * WATT_HOUR)
electricity.set_impact_database_entry("Electricity_New")

propane_transported = model_0.add_energy("Propane for Mixing", "A3")
...
product_1 = model_0.add_product("Product of mixing", "A3")
product_1.set_qty(3.0)
product_1.set_unit(KILOGRAM)

product_2 = model_0.add_product("Product of mixing", "A3")
product_2.set_qty(4.0)
product_2.set_unit(KILOGRAM)

product1_by_truck = model_0.add_transportation_process("Product 01 Transportation", "A2")
...
product2_by_truck = model_0.add_transportation_process("Product 02 Transportation", "A2")
...
CH4 = model_0.add_emission("CH4", "A3")
CH4.set_qty(0.6)
CH4.set_unit(KILOGRAM)
CH4.set_impact_database_entry("CH4")

NH3 = model_0.add_emission("NH3", "A3")
NH3.set_qty(0.7)
