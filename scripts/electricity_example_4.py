...
# [Report] : the data for sense check. What method is preferred--parametric or non-parametric?
...
for distribution in distribution_list:
    ...
    graph.draw(distribution.get_data(), no_bins=3, title=distribution.get_name(), x_label=IMPACT_CATEGOREIS[distribution.get_name()], y_label='probability density', unitize=True)
