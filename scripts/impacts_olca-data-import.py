...
impact_categories = DataImporter.json_to_dict("./data/impact_categories.json")
inventories = DataImporter.json_to_dict("./data/inventories.json")
...
renewable_fuels_process_list = DataImporter.csv_to_list("./data/FLCAC_renewable_fuels.csv", header_name="UUID")
nonrenewable_fuels_process_list = DataImporter.csv_to_list("./data/FLCAC_nonrenewable_fuels.csv", column_index=1)
heating_values = DataImporter.csv_to_dict("./data/FLCAC_heating_values.csv", "UUID")
group_by = [
...
results = openLCA.generate_impacts_dir(
    openLCA_client, my_process_list, impact_categories | inventories, impact_method_uuid, group_by
)
