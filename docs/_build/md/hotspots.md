...
{**impact_category** ([`str`](https://docs.python.org/3/library/stdtypes.html#str)): [`list`](https://docs.python.org/3/library/stdtypes.html#list) of [`Master`](products.md#pod_lca.materials_screening.Master)}.
...
* **Parameters:**
  * **hotspots** ([*list*](https://docs.python.org/3/library/stdtypes.html#list) *of* [*Master*](products.md#pod_lca.materials_screening.Master)) -- List of hotspot object of the model.
