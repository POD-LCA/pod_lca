...
* **Parameters:**
  **parent** ([*Master*](products-and-processes.md#pod_lca.materials_screening.Master)) -- The product or process object to which this record belong.
* **Returns:**
  Record created.
* **Return type:**
...
#### get_record_dict(units=False)

Get the record as a dictionary.

* **Parameters:**
  **units** ([*bool*](https://docs.python.org/3/library/functions.html#bool)) -- If true, returns corresponding units as well.
* **Returns:**
  ...
  or { **impact catergory** ([`str`](https://docs.python.org/3/library/stdtypes.html#str)): (**impact quantity** ([`float`](https://docs.python.org/3/library/functions.html#float)), **unit** ([`str`](https://docs.python.org/3/library/stdtypes.html#str)))}
* **Return type:**
...
* **Parameters:**
  **time_profile** (*DataDistribution*) -- Function describing the dynamic emission profile.
* **Raises:**
