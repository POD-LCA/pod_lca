...
[`ElectricityProducer`](#pod_lca.electricity.ElectricityProducer) class manages the electricity generation aspects including [`Impacts`](impact_records.md#pod_lca.impacts.Impacts) and [`Emissions`](impact_records.md#pod_lca.impacts.Emissions).
...
* **Parameters:**
  **impacts** ([*Impacts*](impact_records.md#pod_lca.impacts.Impacts)) -- Impacts per declared unit of power generation.
...
* **Parameters:**
  **emissions** ([*Emissions*](impact_records.md#pod_lca.impacts.Emissions)) -- Emissions per declared unit of power generation.
