...
* **Parameters:**
  * **location** ([*Location*](location.md#pod_lca.location.Location)) -- The location of the electricity supply authority.
...
* **Returns:**
  * [`list`](https://docs.python.org/3/library/stdtypes.html#list) of [`Impacts`](inventory-records.md#pod_lca.impacts.Impacts) -- Impact objects representing the distribution of the impacts.
...
* **Parameters:**
  ...
  * **location** ([*Location*](location.md#pod_lca.location.Location) *or* [*str*](https://docs.python.org/3/library/stdtypes.html#str)) -- Location of electricity supply.
