...
[`TransportMode`](#pod_lca.transportation.TransportMode) class manages various aspects of transportation modes, including their [`Impacts`](inventory-records.md#pod_lca.impacts.Impacts) and [`Emissions`](inventory-records.md#pod_lca.impacts.Emissions). [`ElectricTransportMode`](#pod_lca.transportation.ElectricTransportMode) is a specific class abstracted to manage electric vehicles and calls the electricity module to manage the impacts and emissions associated.
...
* **Parameters:**
  **parent** ([*TransportationLeg*](logistics-leg.md#pod_lca.transportation.TransportationLeg)) -- The transportation leg to which this mode belong.
...
* **Parameters:**
  **location** ([*Location*](location.md#pod_lca.location.Location)) -- Location of electricity consumption.
...
* **Returns:**
  ...
  * [`Unit`](units-object.md#pod_lca.units.Unit) -- Corresponding unit of measurement.
...
* **Returns:**
  * [`Impacts`](inventory-records.md#pod_lca.impacts.Impacts) -- Unit electricity impacts.
  * [`Emissions`](inventory-records.md#pod_lca.impacts.Emissions) -- Unit electricity emissions.
  * [`Unit`](units-object.md#pod_lca.units.Unit) -- Corresponding electricity supply unit.
