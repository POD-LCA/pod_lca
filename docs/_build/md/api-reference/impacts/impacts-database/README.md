...
* **Parameters:**
  ...
  * **density_headers** ([*str*](https://docs.python.org/3/library/stdtypes.html#str)) -- Headers corresponding to density value, and the units respectively.
...
#### get_data_entry(flow_name, header=None)

Retrieve impacts for given flow.

* **Parameters:**
  * **flow_name** ([*str*](https://docs.python.org/3/library/stdtypes.html#str)) -- Name of the flow.
  * **header** ([*str*](https://docs.python.org/3/library/stdtypes.html#str)) -- Name of the header. If None, the full data row is returned.
* **Returns:**
...
#### find(product, additional_headers=None, shortlist=False, printout=True)

Search for a product in the database. Search is done on the primary data column of the database.

* **Parameters:**
  * **product** ([*str*](https://docs.python.org/3/library/stdtypes.html#str)) -- The product searched for---i.e., search term.
  * **additional_headers** ([*list*](https://docs.python.org/3/library/stdtypes.html#list) *of* [*str*](https://docs.python.org/3/library/stdtypes.html#str)) -- Additional headers in the database to be considered for the search.
  * **shortlist** ([*bool*](https://docs.python.org/3/library/functions.html#bool)) -- If true, shortlist the matching product list based on impacts.
  * **printout** ([*bool*](https://docs.python.org/3/library/functions.html#bool)) -- Print the results if true.
* **Returns:**
...
#### check_database_entry(material)

Check if the database contains the given item.

* **Parameters:**
  **material** ([*str*](https://docs.python.org/3/library/stdtypes.html#str)) -- The name of the database item which gives the item impacts.
* **Returns:**
...
* **Parameters:**
  **mode** ([*TransportMode*](transport-mode.md#pod_lca.transportation.TransportMode)) -- Transport mode with its name, fuel type, and efficiency.
* **Returns:**
  Databse entry corresponding to the flow.
* **Return type:**
  [pandas.Series](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.Series.html#pandas.Series)
