...
Data distributions corresponding to attributes: {**attr** ([`str`](https://docs.python.org/3/library/stdtypes.html#str)): [`DataDistribution`](data-distributions.md#pod_lca.uncertainty.DataDistribution)}.
...
* **Type:**
  [*PedigreeScore*](data-quality-assessment.md#pod_lca.uncertainty.PedigreeScore)
...
* **Parameters:**
  * **distribution** ([*DataDistribution*](data-distributions.md#pod_lca.uncertainty.DataDistribution)) -- DataDistribution object to be set
...
* **Parameters:**
  **pedigree_score** ([*PedigreeScore*](data-quality-assessment.md#pod_lca.uncertainty.PedigreeScore)) -- Data quality indicator for the object
...
* **Returns:**
  DataDistribution objects corresponding to attributes: {**attr** ([`str`](https://docs.python.org/3/library/stdtypes.html#str)): [`DataDistribution`](data-distributions.md#pod_lca.uncertainty.DataDistribution)}
* **Return type:**
  [dict](https://docs.python.org/3/library/stdtypes.html#dict)
...
* **Returns:**
  Data distribution.
* **Return type:**
  [*DataDistribution*](data-distributions.md#pod_lca.uncertainty.DataDistribution)
...
* **Returns:**
  Distributions Datasets corresponding to attributes: {**attr** ([`str`](https://docs.python.org/3/library/stdtypes.html#str)): [`DataDistribution`](data-distributions.md#pod_lca.uncertainty.DataDistribution)}.
* **Return type:**
  [dict](https://docs.python.org/3/library/stdtypes.html#dict)
