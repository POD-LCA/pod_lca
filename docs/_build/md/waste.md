...
Bases: [`Product`](products.md#pod_lca.materials_screening.Product)
...
* **Type:**
  *BuildingComponent* or [*Product*](products.md#pod_lca.materials_screening.Product)
...
* **Type:**
  [list](https://docs.python.org/3/library/stdtypes.html#list) of [*WasteProcess*](waste_processing.md#pod_lca.eol.WasteProcess)
...
Impact objects categorized by life cycle stage {**life cycle stage** ([`str`](https://docs.python.org/3/library/stdtypes.html#str)): list of [`Impacts`](impact_records.md#pod_lca.impacts.Impacts)}
...
Emission objects categorized by life cycle stage {**life cycle stage** ([`str`](https://docs.python.org/3/library/stdtypes.html#str)): list of [`Emissions`](impact_records.md#pod_lca.impacts.Emissions)}
...
* **Parameters:**
  * **parent** (*BuildingComponent* *or* [*Product*](products.md#pod_lca.materials_screening.Product)) -- The thing that which was converted to waste.
  ...
  * **unit** ([*Unit*](units.md#pod_lca.units.Unit)) -- Unit of measurement corresponding to the quantity of the product/process.
...
* **Returns:**
  * [`WasteProcess`](waste_processing.md#pod_lca.eol.WasteProcess) -- If the process is not cutoff
