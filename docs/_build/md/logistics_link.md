...
* **Parameters:**
  * **good** ([*Product*](products.md#pod_lca.materials_screening.Product)) -- Product being transported.
  * **manager** ([*TransportationManager*](project_logistic_manager.md#pod_lca.transportation.TransportationManager)) -- The project to which the transportation leg belongs.
...
* **Parameters:**
  **project** ([*TransportationManager*](project_logistic_manager.md#pod_lca.transportation.TransportationManager)) -- The project to which the transportation leg belong.
...
* **Parameters:**
  **material** ([*Product*](products.md#pod_lca.materials_screening.Product)) -- Material being transported.
...
* **Parameters:**
  ...
  * **dist_unit** ([*Unit*](units.md#pod_lca.units.Unit)) -- Unit of the travel distance. Defualt is KILOMETER
...
* **Parameters:**
  **shipping_dest** ([*Location*](location_module.md#pod_lca.location.Location)) -- Name of the shipping destination location.
* **Raises:**
...
* **Parameters:**
  **shipping_org** ([*Location*](location_module.md#pod_lca.location.Location)) -- Name of the shipping origin location.
* **Raises:**
...
* **Parameters:**
  * **mode** ([*str*](https://docs.python.org/3/library/stdtypes.html#str) *or* [*TransportMode*](transport_mode.md#pod_lca.transportation.TransportMode)) -- transportation mode of the transportation leg.
...
* **Return type:**
  [*Product*](products.md#pod_lca.materials_screening.Product)
...
* **Type:**
  {'National', 'Regional', 'Regional_c', 'Local', 'Average'}
...
* **Parameters:**
  **transport_scenario** ( *{'National'* *,*  *'Regional'* *,*  *'Regional_c'* *,*  *'Local'* *,*  *'Average'}*) -- Transport scenario of the transportation leg.
* **Raises:**
...
* **Parameters:**
  **shipping_dest** ([*Location*](location_module.md#pod_lca.location.Location)) -- Shipping destination location.
...
* **Parameters:**
  **shipping_org** ([*Location*](location_module.md#pod_lca.location.Location)) -- Shipping origin location.
...
* **Parameters:**
  ...
  * **dist_unit** ([*Unit*](units.md#pod_lca.units.Unit)) -- Unit of the travel distance.
  * **return_trip_factor** ([*float*](https://docs.python.org/3/library/functions.html#float)) -- Return trip factor of the transportation leg.
...
#### get_distance_from_datset(transport_scenario)
...
* **Parameters:**
  * **good** ([*Master*](products.md#pod_lca.materials_screening.Master)) -- Product being transported.
  * **project** ([*Project*](material_screening_project.md#pod_lca.materials_screening.Project)) -- The project to which the transportation leg belongs.
  * **name** ([*str*](https://docs.python.org/3/library/stdtypes.html#str)) -- Name of the transportation leg (default is None).
* **Returns:**
  Transportation leg created in the project.
* **Return type:**
...
* **Parameters:**
  * **material** ([*WasteProcess*](waste_processing.md#pod_lca.eol.WasteProcess)) -- Material keeping quantity and unit record.
...
* **Parameters:**
  **material** ([*Product*](products.md#pod_lca.materials_screening.Product)) -- Material name of the transportation leg.
