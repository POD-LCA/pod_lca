...
* **Type:**
  [*TransportationManager*](project-logistic-manager.md#pod_lca.transportation.TransportationManager)
...
* **Parameters:**
  ...
  * **manager** ([*TransportationManager*](project-logistic-manager.md#pod_lca.transportation.TransportationManager)) -- The project to which the transportation leg belongs.
...
* **Parameters:**
  **project** ([*TransportationManager*](project-logistic-manager.md#pod_lca.transportation.TransportationManager)) -- The project to which the transportation leg belong.
