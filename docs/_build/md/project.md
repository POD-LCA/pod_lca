...
* **Parameters:**
  **database** ([*ImpactsDatabase*](impacts-database.md#pod_lca.impacts.ImpactsDatabase) *or* [*str*](https://docs.python.org/3/library/stdtypes.html#str)) -- Impact database object or if a string, filepath to the corresponding csv file containing impact data.
* **Raises:**
