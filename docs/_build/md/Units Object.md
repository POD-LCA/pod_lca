...
[`Unit`](#pod_lca.units.Unit) and [`MetricPrefix`](metrix-prefixes.md#pod_lca.units.MetricPrefix) objects manage unit multiplication/division and unit conversions.
...
* **Returns:**
  * [`float`](https://docs.python.org/3/library/functions.html#float) -- Conversion factor resulting from the simplification.
  * [`Unit`](#pod_lca.units.Unit) -- Simplified unit.
