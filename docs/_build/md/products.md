...
[`Product`](#pod_lca.materials_screening.Product) and [`Process`](#pod_lca.materials_screening.Process) objects keeps track of product/process quantities and their LCA data (e.g., [`Impacts`](impact_records.md#pod_lca.impacts.Impacts), [`Emissions`](impact_records.md#pod_lca.impacts.Emissions)). They both inherit from the abstract class [`Master`](#pod_lca.materials_screening.Master).
...
Data distributions corresponding to attributes: {**attr** ([`str`](https://docs.python.org/3/library/stdtypes.html#str)): [`DataDistribution`](datasets.md#pod_lca.uncertainty.DataDistribution)}.
...
* **Parameters:**
  ...
  * **unit** ([*Unit*](units.md#pod_lca.units.Unit)) -- Unit corresponding to the quantity.
...
* **Parameters:**
  **unit** ([*Unit*](units.md#pod_lca.units.Unit)) -- Unit of measurement.
* **Raises:**
...
* **Parameters:**
  * **distribution** ([*DataDistribution*](datasets.md#pod_lca.uncertainty.DataDistribution)) -- DataDistribution object to be set
...
* **Parameters:**
  **pedigree_score** ([*PedigreeScore*](data_quality_assessment.md#pod_lca.uncertainty.PedigreeScore)) -- Data quality indicator for the object
...
* **Returns:**
  DataDistribution objects corresponding to attributes: {**attr** ([`str`](https://docs.python.org/3/library/stdtypes.html#str)): [`DataDistribution`](datasets.md#pod_lca.uncertainty.DataDistribution)}
* **Return type:**
  [dict](https://docs.python.org/3/library/stdtypes.html#dict)
...
* **Returns:**
  Distributions Datasets corresponding to attributes: {**attr** ([`str`](https://docs.python.org/3/library/stdtypes.html#str)): [`DataDistribution`](datasets.md#pod_lca.uncertainty.DataDistribution)}.
* **Return type:**
  [dict](https://docs.python.org/3/library/stdtypes.html#dict)
...
* **Return type:**
  [*Project*](material_screening_project.md#pod_lca.materials_screening.Project)
...
#### set_weight_unit(unit)

Set unit of measurement for the mass of the product.

* **Parameters:**
  **unit** ([*Unit*](units.md#pod_lca.units.Unit)) -- Unit of measurement. of mass.
...
* **Parameters:**
  **density** ([*float*](https://docs.python.org/3/library/functions.html#float)) -- Denisty of product (mass per unit mesurement of product).
* **Raises:**
...
* **Parameters:**
  ...
  * **unit** ([*Unit*](units.md#pod_lca.units.Unit)) -- Unit of accelerated carbonation uptake.
  * **per** ([*dict*](https://docs.python.org/3/library/stdtypes.html#dict) *or* [*Unit*](units.md#pod_lca.units.Unit)) -- Parent quantity for which the mineral carbon intensity is declared.
    If dict, {'per': {'qty': ([`int`](https://docs.python.org/3/library/functions.html#int) or [`float`](https://docs.python.org/3/library/functions.html#float)), 'unit': ([`Unit`](units.md#pod_lca.units.Unit))}}
...
* **Parameters:**
  ...
  * **unit** ([*Unit*](units.md#pod_lca.units.Unit)) -- Unit of electricity consumption.
  * **impacts** ([*Impacts*](impact_records.md#pod_lca.impacts.Impacts)) -- Impacts corresponding to electricity consumption.
  * **emissions** ([*Emissions*](impact_records.md#pod_lca.impacts.Emissions)) -- Emissions corresponding to electricity consumption.
  * **carbon_storage** ([*CarbonStorage*](impact_records.md#pod_lca.impacts.CarbonStorage)) -- Carbon storage corresponding to electricity consumption.
...
* **Parameters:**
  **supplier** ([*ElectricitySupply*](electricity_supply.md#pod_lca.electricity.ElectricitySupply)) -- Electricity supply
