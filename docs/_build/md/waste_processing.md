...
[`WasteProcess`](#pod_lca.eol.WasteProcess) maintains data relevant to the end-of-life pathways, including their [`Impacts`](impact_records.md#pod_lca.impacts.Impacts) and [`Emissions`](impact_records.md#pod_lca.impacts.Emissions).
...
* **Parameters:**
  * **parent** ([*Waste*](waste.md#pod_lca.eol.Waste)) -- Waste object for which the waste processing belong.
...
* **Parameters:**
  **unit** ([*Unit*](units.md#pod_lca.units.Unit)) -- Unit of measurement.
* **Raises:**
  [**ValueError**](https://docs.python.org/3/library/exceptions.html#ValueError) -- New unit incompatible with the existing units.
...
* **Parameters:**
  **location** ([*Location*](location_module.md#pod_lca.location.Location)) -- Location of the waster process facility.
