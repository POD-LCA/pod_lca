...
* **Type:**
  *Assembly* or [*Product*](products-and-processes.md#pod_lca.materials_screening.Product)
...
* **Parameters:**
  * **parent** (*Assembly* *or* [*Product*](products-and-processes.md#pod_lca.materials_screening.Product)) -- The thing that which was converted to waste.
...
* **Parameters:**
  **year** ([*int*](https://docs.python.org/3/library/functions.html#int)) -- Year in which the waste is generated.
...
#### get_eol_process_impact_database()
