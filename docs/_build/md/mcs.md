...
* **Type:**
  [list](https://docs.python.org/3/library/stdtypes.html#list) of [*DataDistribution*](datasets.md#pod_lca.uncertainty.DataDistribution)

#### scenario

Dictionary of objects and the scenario set to them; {**object** ([`Master`](products.md#pod_lca.materials_screening.Master)): **scenario** ([`str`](https://docs.python.org/3/library/stdtypes.html#str))}.
...
* **Parameters:**
  **scenario** ([*dict*](https://docs.python.org/3/library/stdtypes.html#dict)) -- Dictionary of objects and the scenario set to them; {**object** ([`Master`](products.md#pod_lca.materials_screening.Master)): **scenario** ([`str`](https://docs.python.org/3/library/stdtypes.html#str))}.
  Scenario values are 'low', 'med', and 'high'.
