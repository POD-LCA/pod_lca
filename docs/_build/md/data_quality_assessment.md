...
[`PedigreeScore`](#pod_lca.uncertainty.PedigreeScore) objects are assigned to each [`Product`](products.md#pod_lca.materials_screening.Product) object and can be accessed from [`get_pedigree_score()`](products.md#pod_lca.materials_screening.Master.get_pedigree_score).
...
* **Parameters:**
  **parent** ([*Master*](products.md#pod_lca.materials_screening.Master)) -- Parent object.
...
* **Parameters:**
  **obj** ([*Master*](products.md#pod_lca.materials_screening.Master)) -- Object to which the pedigree score correspond.
