...
| Unit Object Name  | Unit Name  | Standard Notation |  Conversion Factor  |
+===================+============+===================+=====================+
| GRAM              | gram       | g                 |  907184.74          |
+-------------------+------------+-------------------+---------------------+
| M_TON             | metric Ton | t                 |  0.90718474         |
+-------------------+------------+-------------------+---------------------+
| S_TON             | short Ton  | tn                |  1.0                |
+-------------------+------------+-------------------+---------------------+
| POUND             | pound      | lb                |  2000               |
+-------------------+------------+-------------------+---------------------+
...
| Unit Object Name  | Unit Name    | Standard Notation |  Conversion Factor  |
+===================+==============+===================+=====================+
| SQUARE_METER      | square meter | m2                |  4046.8564224       |
+-------------------+--------------+-------------------+---------------------+
| SQUARE_FEET       | square feet  | ft2               |  43560              |
+-------------------+--------------+-------------------+---------------------+
| ACRE              | acre         | acre              |  1.0                |
+-------------------+--------------+-------------------+---------------------+
| HECTARE           | hectare      | ha                |  0.40468564224      |
+-------------------+--------------+-------------------+---------------------+
