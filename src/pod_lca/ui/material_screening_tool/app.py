...
class App(
    ...
    def create_palette(self, frame):
        ...
        self.model_object_button = Button(
            palette_frame,
            bg=model_button_color,
            highlightbackground=model_button_color,
            fg="white",
            height=button_height,
            width=button_width,
            font=button_font,
            text="Model",
            command=lambda: self.add_model_context_menu(palette_frame),
        )
        self.model_object_button.pack(side=button_side, padx=padx, pady=pady)

        product_object_button = Button(
            palette_frame,
            bg=button_color,
        ...
        process_object_button = Button(
            ...
            font=button_font,
            text="Process",
            command=self.open_popup_process,
        )
        process_object_button.pack(side=LEFT, padx=padx, pady=pady)

        transportation_object_button = Button(
            palette_frame,
            bg=button_color,
            fg=button_font_color,
            height=button_height,
            ...
            font=button_font,
            text="Transportation",
            command=self.open_popup_transport_process,
        )
        transportation_object_button.pack(side=LEFT, padx=padx, pady=pady)

        Energy_object_button = Button(
            palette_frame,
            bg=button_color,
            highlightbackground=button_color,
            fg=button_font_color,
        ...
        parameter_object_button = Button(
            ...
            font=button_font,
            text="Parameter",
            command=self.open_popup_parameter,
        )
    ...
    def create_plotter(self, frame):
        ...
        self.dropdown_plot = Combobox(
            input_frame_plot_type, values=["Bar chart 1", "Bar chart 2", "Bar chart 3", "Radar plot"]
        )
        ...
        label = Label(
            input_frame_impact_cat,
            bg=self.plotter_bg_color,
            fg="white",
            text="Environmental impact category",
            font=("Helvetica", 12, "bold"),
        )
        label.pack(side=LEFT, padx=(0, 10))
