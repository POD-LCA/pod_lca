...
class EmissionProduct(Product):
    ...
    def open_popup_emission(self):
        ...
        cmd = lambda: self.create_emission_product(
    ...
    def create_emission_product(self, popup, name, qty, unit, stage, lca_data):
        ...
        if product is not None:
            ...
            item_id, text_item, text_id = EmissionProduct.create_canvas_item(
                self, model_id, name, stage, qty, unit, self.color_emission, tags=["product", "emission"]
            )
            slider_cmd = lambda x: EmissionProduct.update_qty(self, item_id, x)
            slider, slider_data = EmissionProduct.create_slider(
