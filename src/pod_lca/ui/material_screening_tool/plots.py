...
class PlotsMixin:
    ...
    def create_figure(self, plot_frame, impact_cat, plot_type="Bar chart 1"):
        ...
        if plot_type == "Bar chart 1":
            ...
            graph.draw(
                Calculator.get_impacts_by_LCstages_models(impact_cat, model_lst),
                f"{impact_cat} by Life Cycle Stages",
                "Life Cycle Stages",
                f"{impact_cat}",
            )
            ...
            graph = BarChart.from_plotter(MatplotlibPlotter)
            graph.draw(
                Calculator.get_impacts_by_LCstages_models_items(impact_cat, model_lst),
                f"{impact_cat} by Life Cycle Stages-categorized by ",
                "Life Cycle Stages",
                f"{impact_cat}",
            )
            ...
            graph = BarChart.from_plotter(MatplotlibPlotter)
            graph.draw(
                Calculator.get_impacts_by_impactcategorys_models_LCstage(impact_cat, model_lst),
                "Impacts by stages",
                "Impact Category",
                "Impact Value",
            )
    ...
    def replace_figure(self, plot_frame, plot_type):
        ...
        if plot_type == "Bar chart 1":
            ...
            graph = BarChart.from_plotter(MatplotlibPlotter)
            graph.draw(
                Calculator.get_impacts_by_LCstages_models_items(self.get_impact_selection(), model_lst),
                f"{self.get_impact_selection()} by Life Cycle Stages-categorized by ",
                "Life Cycle Stages",
                f"{self.get_impact_selection()}",
            )
        elif plot_type == "Bar chart 3":
            ...
            graph = BarChart.from_plotter(MatplotlibPlotter)
            graph.draw(
                Calculator.get_impacts_by_impactcategorys_models_LCstage(self.get_impact_selection(), model_lst),
                "Impacts by stages",
                "Impact Category",
                "Impact Value",
            )
