...
def find_zones(filepath, data):
    ...
    for i in i_lines:
        ...
        data["zones"][name] = {"name": name, "origin": [x, y, z], "height": h, "volume": v, "surfaces": {}}
...
def find_glazing_material_simple(filepath, data):
    ...
    for i in i_lines:
        ...
        data["materials"][name] = {
            "__type__": "WindowMaterialGlazingSimple",
            "name": name,
            "u_factor": ufac,
...
def find_daylight_controls(filepath, data):
    ...
    for i in i_lines:
        ...
        data["daylighting_controls"][name] = {
            "name": name,
            "zone_name": znam,
...
def find_daylight_reference_points(filepath, data):
    ...
    for i in i_lines:
        ...
        data["daylighting:referencepoint"][name] = {
            "name": name,
            "zone_name": znam,
            "x": x,
            "y": y,
...
def find_zone_control_thermostat(filepath, data):
    ...
    for i in i_lines:
        ...
        data["zone_control_thermostat"][name] = {
            "name": name,
            "zone_name": znam,
            "schedule_name": snam,
...
def find_equipment_connections(filepath, data):
    ...
    for i in i_lines:
        ...
        data["equipment_connection"][name] = {
            "name": name,
