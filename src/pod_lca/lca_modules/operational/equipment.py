...
class EquipmentList(object):
    ...
    def from_data(cls, data):
        ...
        eql.zone_equipment_sequenctial_cooling_fraction_schedule = data[
            "zone_equipment_sequenctial_cooling_fraction_schedule"
        ]
        eql.zone_equipment_sequential_heating_fraction_schedule = data[
            "zone_equipment_sequential_heating_fraction_schedule"
        ]
        return eql
    ...
    def data(self):
        ...
        data["zone_equipment_sequenctial_cooling_fraction_schedule"] = (
            self.zone_equipment_sequenctial_cooling_fraction_schedule
        )
        data["zone_equipment_sequential_heating_fraction_schedule"] = (
            self.zone_equipment_sequential_heating_fraction_schedule
        )
        return data
