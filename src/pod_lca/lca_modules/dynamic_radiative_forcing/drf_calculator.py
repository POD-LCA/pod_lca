...
class DynamicRadiativeForcing:
    ...
    def get_radiative_efficiency(self, greenhouse_gas, ref_unit="Wm-2ppb-1", adjust_for_indirect_effects=True):
        ...
        """
        return self.calculator.get_radiative_efficiency(greenhouse_gas, 
                                                        ref_unit, 
                                                        adjust_for_indirect_effects)
    ...
    def get_atmospheric_concentration(self, greenhouse_gas, at_year, cumulative=False):
        ...
        """
        return self.calculator.get_atmospheric_concentration(greenhouse_gas, 
                                                            at_year, 
                                                            cumulative)

    def get_radiative_forcing(self, greenhouse_gas, at_year, cumulative=False, CH4_oxidation=False, alpha=0.5, convolution_time_step = 0.01):
        ...
        """
        return self.calculator.get_radiative_forcing(self, 
                                                     greenhouse_gas, 
                                                     at_year, 
                                                     cumulative, 
                                                     CH4_oxidation, 
    ...
    def get_concentration_time_series(self, greenhouse_gas, time_horizon, time_step, cumulative=False):
        ...
        if years[-1] > time_horizon:
            years = years[:-1]
        concentrations = self.get_atmospheric_concentration(greenhouse_gas, years, cumulative) # TODO: check the at_years variable
        return years, concentrations
        
    def get_radiative_forcing_time_series(self, greenhouse_gas, time_horizon, time_step, cumulative=True, CH4_oxidation=False, alpha=0.5):
        ...
        ValueError  
            Reference unit not recognized.
        """
        return self.calculator.get_radiative_forcing_time_series(greenhouse_gas, 
                                                      time_horizon, 
                                                      time_step, 
                                                      cumulative, 
                                                      CH4_oxidation, 
