...
.. image:: /Images/Program_structure.png
  :width: 1000
  :alt: Add alternative text

The class structure if the code base is as below.

.. image:: /Images/Class_diagram_overall.png
  :width: 1000
  :alt: Add alternative text
...
.. image:: /Images/Class_diagram_masterObject.png
  :width: 1000
  :alt: Add alternative text

:class:`Plotter <visualizer.plotter.Plotter>` provide an abstract class to create visualizations.

.. image:: /Images/Class_diagram_plotters.png
  :width: 1000
  :alt: Add alternative text

:class:`Calculator <calculator.calculator.Calculator>` is the place to add new computation methods to reorganize (or work with) the impact data from the :class:`Models <model.model.Model>`.
