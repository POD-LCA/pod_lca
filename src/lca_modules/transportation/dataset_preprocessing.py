...
def faf_preprocessing (input_path_faf, output_path_faf):
    ...
    dist_fr = pd.read_csv(r"data\transportation_dataset\transportation_podlca_dist-fr.csv")
    faf_dist_band = pd.read_csv(r"data\transportation_dataset\transportation_podlca_faf-dist-band.csv")
